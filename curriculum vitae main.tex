...
\newcommand{\contact}
{
    ...
    \textcolor{white}
    {
        ...
        \hspace{2em}    % 这里可以调间距
        \faWechat \quad \color{orange}wechataccount               % 微信
        \hspace{2em}    % 这里可以调间距
        \faPhone \quad \color{orange}12345678901                % 手机号
        \hspace{2em}    % 这里可以调间距
        \faGithub \quad \href{https://github.com/XiaoHongyyds}{\color{orange}XiaoHongyyds}         % github
    }
}
